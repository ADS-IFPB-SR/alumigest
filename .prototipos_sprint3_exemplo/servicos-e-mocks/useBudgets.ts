...
import type { Budget, Customer, BudgetStatus } from '../../catalog/types';
import { getBudgets, getBudgetById, createBudget, updateBudget, updateBudgetStatus, getCustomers, saveCustomer } from '../services/budgetStorage';
import type { BudgetItem } from '../../catalog/types';
