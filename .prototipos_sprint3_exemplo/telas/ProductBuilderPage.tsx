...
import { ProductTechSheet } from '../features/catalog/components/builder/ProductTechSheet';
import type { DoorTemplateType, TemplateConfig, ProductCategoryRequirement } from '../features/catalog/types';
