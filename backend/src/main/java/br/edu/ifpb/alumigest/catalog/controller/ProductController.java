...
public class ProductController {
    ...
    @PostMapping
    @Operation(summary = "Cadastrar Produto ou Template", description = "Cria um novo produto ou template de esquadria (SWING, SLIDING, AWNING, DRAWER) com seu esquema de opções e requisitos de categorias de insumos.")
