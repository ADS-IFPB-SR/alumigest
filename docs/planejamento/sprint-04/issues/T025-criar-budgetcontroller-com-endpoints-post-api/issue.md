# [T025] Criar `BudgetController` com endpoints POST /api/budgets, GET /api/budgets, GET /api/budgets/{id}, POST /api/budgets/{id}/items, PUT /api/budgets/{id}/discount, PATCH /api/budgets/{id}/status conforme `contracts/api-budgets.md` em `backend/src/main/java/br/edu/ifpb/alumigest/budgets/controller/BudgetController.java`
...
Criar `BudgetController` com endpoints POST /api/budgets, GET /api/budgets, GET /api/budgets/{id}, POST /api/budgets/{id}/items, PUT /api/budgets/{id}/discount, PATCH /api/budgets/{id}/status conforme `contracts/api-budgets.md` em `backend/src/main/java/br/edu/ifpb/alumigest/budgets/controller/BudgetController.java`.
...
- [ ] Implementar a alteração necessária em `backend/src/main/java/br/edu/ifpb/alumigest/budgets/controller/BudgetController.java`
