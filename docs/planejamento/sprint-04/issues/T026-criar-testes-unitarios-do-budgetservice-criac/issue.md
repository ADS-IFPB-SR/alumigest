# [T026] Criar testes unitários do `BudgetService` (criação, desconto percentual, desconto valor fixo, validações de limites, transições de status) em `backend/src/test/java/br/edu/ifpb/alumigest/budgets/service/BudgetServiceTest.java`
...
- **User Story**: [US1]
- **Sub-área**: `Testes Backend`
- **Execução Paralela**: ✅ Sim (Pode ser executada em paralelo com outras tasks [P])
- **Arquivo / Alvo Principal**: `backend/src/test/java/br/edu/ifpb/alumigest/budgets/service/BudgetServiceTest.java`
- **Labels Sugeridas**: `sprint-04`, `release-1`, `backend`, `java`, `testing`, `mvp`, `user-story-1`

---

## 🎯 Objetivo & Descrição

Criar testes unitários do `BudgetService` (criação, desconto percentual, desconto valor fixo, validações de limites, transições de status) em `backend/src/test/java/br/edu/ifpb/alumigest/budgets/service/BudgetServiceTest.java`.
...
- [ ] Implementar a alteração necessária em `backend/src/test/java/br/edu/ifpb/alumigest/budgets/service/BudgetServiceTest.java`
...
1. A funcionalidade descrita em `T026` deve estar completamente implementada no arquivo alvo.
