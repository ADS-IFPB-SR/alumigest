# [T027] Criar testes de integração do `BudgetController` (endpoints CRUD, desconto, status) com H2 em `backend/src/test/java/br/edu/ifpb/alumigest/budgets/controller/BudgetControllerIntegrationTest.java`
...
- **Arquivo / Alvo Principal**: `backend/src/test/java/br/edu/ifpb/alumigest/budgets/controller/BudgetControllerIntegrationTest.java`
...
Criar testes de integração do `BudgetController` (endpoints CRUD, desconto, status) com H2 em `backend/src/test/java/br/edu/ifpb/alumigest/budgets/controller/BudgetControllerIntegrationTest.java`.
...
- [ ] Implementar a alteração necessária em `backend/src/test/java/br/edu/ifpb/alumigest/budgets/controller/BudgetControllerIntegrationTest.java`
...
1. A funcionalidade descrita em `T027` deve estar completamente implementada no arquivo alvo.
