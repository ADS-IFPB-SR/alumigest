# [T028] Criar interfaces TypeScript (Budget, BudgetItem, BudgetCreateRequest, DiscountRequest, etc.) em `frontend/src/features/budgets/types/budget.ts`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/budgets/types/budget.ts`
...
Criar interfaces TypeScript (Budget, BudgetItem, BudgetCreateRequest, DiscountRequest, etc.) em `frontend/src/features/budgets/types/budget.ts`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/budgets/types/budget.ts`
