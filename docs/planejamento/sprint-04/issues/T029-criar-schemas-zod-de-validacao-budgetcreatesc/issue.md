# [T029] Criar schemas Zod de validação (budgetCreateSchema, budgetItemSchema, discountSchema) em `frontend/src/features/budgets/schemas/budgetSchema.ts`
...
- **Labels Sugeridas**: `sprint-04`, `release-1`, `frontend`, `typescript`, `react`, `database`, `mvp`, `user-story-1`
