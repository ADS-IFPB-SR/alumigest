# [T030] Criar serviço de API Axios (createBudget, listBudgets, getBudget, addItem, applyDiscount, changeStatus) em `frontend/src/features/budgets/services/budgetApi.ts`
...
- **Labels Sugeridas**: `sprint-04`, `release-1`, `backend`, `java`, `frontend`, `typescript`, `react`, `mvp`, `user-story-1`

---

## 🎯 Objetivo & Descrição

Criar serviço de API Axios (createBudget, listBudgets, getBudget, addItem, applyDiscount, changeStatus) em `frontend/src/features/budgets/services/budgetApi.ts`.
