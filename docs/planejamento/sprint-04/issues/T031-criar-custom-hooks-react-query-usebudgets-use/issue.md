# [T031] Criar custom hooks React Query (useBudgets, useBudget, useCreateBudget, useAddItem, useApplyDiscount) em `frontend/src/features/budgets/hooks/useBudgets.ts`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/budgets/hooks/useBudgets.ts`
...
Criar custom hooks React Query (useBudgets, useBudget, useCreateBudget, useAddItem, useApplyDiscount) em `frontend/src/features/budgets/hooks/useBudgets.ts`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/budgets/hooks/useBudgets.ts`
