# [T032] Criar componente `BudgetStatusBadge` (badge visual colorido por status com indicador de expirado) em `frontend/src/features/budgets/components/BudgetStatusBadge.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/budgets/components/BudgetStatusBadge.tsx`
...
Criar componente `BudgetStatusBadge` (badge visual colorido por status com indicador de expirado) em `frontend/src/features/budgets/components/BudgetStatusBadge.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/budgets/components/BudgetStatusBadge.tsx`
...
1. A funcionalidade descrita em `T032` deve estar completamente implementada no arquivo alvo.
