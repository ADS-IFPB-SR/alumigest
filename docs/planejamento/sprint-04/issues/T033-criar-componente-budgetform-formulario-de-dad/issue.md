# [T033] Criar componente `BudgetForm` (formulário de dados do cliente com react-hook-form + zod) em `frontend/src/features/budgets/components/BudgetForm.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/budgets/components/BudgetForm.tsx`
...
Criar componente `BudgetForm` (formulário de dados do cliente com react-hook-form + zod) em `frontend/src/features/budgets/components/BudgetForm.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/budgets/components/BudgetForm.tsx`
