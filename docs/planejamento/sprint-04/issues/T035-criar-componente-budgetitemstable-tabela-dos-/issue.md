# [T035] Criar componente `BudgetItemsTable` (tabela dos itens do orçamento com valores) em `frontend/src/features/budgets/components/BudgetItemsTable.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/budgets/components/BudgetItemsTable.tsx`
...
Criar componente `BudgetItemsTable` (tabela dos itens do orçamento com valores) em `frontend/src/features/budgets/components/BudgetItemsTable.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/budgets/components/BudgetItemsTable.tsx`
