# [T036] Criar componente `DiscountPanel` (painel de desconto % ou R$, seleção de condição de pagamento, validade) em `frontend/src/features/budgets/components/DiscountPanel.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/budgets/components/DiscountPanel.tsx`
...
Criar componente `DiscountPanel` (painel de desconto % ou R$, seleção de condição de pagamento, validade) em `frontend/src/features/budgets/components/DiscountPanel.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/budgets/components/DiscountPanel.tsx`
...
1. A funcionalidade descrita em `T036` deve estar completamente implementada no arquivo alvo.
