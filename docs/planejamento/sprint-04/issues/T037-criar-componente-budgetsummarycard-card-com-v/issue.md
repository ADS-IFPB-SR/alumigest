# [T037] Criar componente `BudgetSummaryCard` (card com valor bruto, desconto, taxas e total líquido) em `frontend/src/features/budgets/components/BudgetSummaryCard.tsx`
...
Criar componente `BudgetSummaryCard` (card com valor bruto, desconto, taxas e total líquido) em `frontend/src/features/budgets/components/BudgetSummaryCard.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/budgets/components/BudgetSummaryCard.tsx`
