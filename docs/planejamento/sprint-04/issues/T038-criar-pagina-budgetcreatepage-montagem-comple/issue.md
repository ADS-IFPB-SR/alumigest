# [T038] Criar página `BudgetCreatePage` (montagem completa do orçamento com formulário, itens e desconto) em `frontend/src/pages/BudgetCreatePage.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/pages/BudgetCreatePage.tsx`
...
Criar página `BudgetCreatePage` (montagem completa do orçamento com formulário, itens e desconto) em `frontend/src/pages/BudgetCreatePage.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/pages/BudgetCreatePage.tsx`
...
1. A funcionalidade descrita em `T038` deve estar completamente implementada no arquivo alvo.
