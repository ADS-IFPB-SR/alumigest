# [T039] Criar página `BudgetListPage` (listagem paginada com filtros de status e busca) em `frontend/src/pages/BudgetListPage.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/pages/BudgetListPage.tsx`
...
Criar página `BudgetListPage` (listagem paginada com filtros de status e busca) em `frontend/src/pages/BudgetListPage.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/pages/BudgetListPage.tsx`
