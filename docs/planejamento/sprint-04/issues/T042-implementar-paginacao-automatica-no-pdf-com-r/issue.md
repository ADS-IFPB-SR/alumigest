# [T042] Implementar paginação automática no PDF com rodapé "Página X de Y" e repetição de cabeçalho simplificado no `BudgetPdfService`
...
- **Labels Sugeridas**: `sprint-04`, `release-1`, `backend`, `java`, `pdf`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Implementar paginação automática no PDF com rodapé "Página X de Y" e repetição de cabeçalho simplificado no `BudgetPdfService`.
...
1. A funcionalidade descrita em `T042` deve estar completamente implementada no arquivo alvo.
