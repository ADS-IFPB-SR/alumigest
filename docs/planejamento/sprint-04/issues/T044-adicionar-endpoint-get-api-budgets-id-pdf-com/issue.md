# [T044] Adicionar endpoint GET /api/budgets/{id}/pdf/comercial no `BudgetController` (retorna application/pdf com Content-Disposition attachment)
...
- **User Story**: [US2]
- **Sub-área**: `Backend — Endpoints de PDF`
- **Execução Paralela**: ❌ Não (Execução sequencial recomendada)
- **Arquivo / Alvo Principal**: `BudgetController`
- **Labels Sugeridas**: `sprint-04`, `release-1`, `backend`, `java`, `pdf`, `devops-docs`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Adicionar endpoint GET /api/budgets/{id}/pdf/comercial no `BudgetController` (retorna application/pdf com Content-Disposition attachment).
...
- [ ] Implementar a alteração necessária em `BudgetController`
...
1. A funcionalidade descrita em `T044` deve estar completamente implementada no arquivo alvo.
