# [T045] Adicionar endpoint GET /api/budgets/{id}/resumo-whatsapp no `BudgetController` (retorna text/plain UTF-8)
...
- **Labels Sugeridas**: `sprint-04`, `release-1`, `backend`, `java`, `whatsapp-integration`, `devops-docs`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Adicionar endpoint GET /api/budgets/{id}/resumo-whatsapp no `BudgetController` (retorna text/plain UTF-8).
...
1. A funcionalidade descrita em `T045` deve estar completamente implementada no arquivo alvo.
