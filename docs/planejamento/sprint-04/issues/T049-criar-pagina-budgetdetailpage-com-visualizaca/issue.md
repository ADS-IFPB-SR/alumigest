# [T049] Criar página `BudgetDetailPage` com visualização do orçamento, botões "Emitir PDF Comercial", "Copiar para WhatsApp" e ações de status em `frontend/src/pages/BudgetDetailPage.tsx`
...
- **Labels Sugeridas**: `sprint-04`, `release-1`, `frontend`, `typescript`, `react`, `pdf`, `whatsapp-integration`, `devops-docs`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Criar página `BudgetDetailPage` com visualização do orçamento, botões "Emitir PDF Comercial", "Copiar para WhatsApp" e ações de status em `frontend/src/pages/BudgetDetailPage.tsx`.
...
1. A funcionalidade descrita em `T049` deve estar completamente implementada no arquivo alvo.
