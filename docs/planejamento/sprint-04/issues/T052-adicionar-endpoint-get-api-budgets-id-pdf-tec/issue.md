# [T052] Adicionar endpoint GET /api/budgets/{id}/pdf/tecnico no `BudgetController` (retorna application/pdf)
...
- **User Story**: [US3]
- **Sub-área**: `Backend — Endpoint`
- **Execução Paralela**: ❌ Não (Execução sequencial recomendada)
- **Arquivo / Alvo Principal**: `BudgetController`
- **Labels Sugeridas**: `sprint-04`, `release-1`, `backend`, `java`, `pdf`, `devops-docs`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Adicionar endpoint GET /api/budgets/{id}/pdf/tecnico no `BudgetController` (retorna application/pdf).
...
1. A funcionalidade descrita em `T052` deve estar completamente implementada no arquivo alvo.
