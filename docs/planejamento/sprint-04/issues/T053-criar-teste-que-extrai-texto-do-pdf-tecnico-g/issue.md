# [T053] Criar teste que extrai texto do PDF técnico gerado e verifica ausência de padrão monetário (R$, valor, preço, total) em `BudgetPdfServiceTest`
...
- **Arquivo / Alvo Principal**: `BudgetPdfServiceTest`
- **Labels Sugeridas**: `sprint-04`, `release-1`, `backend`, `java`, `testing`, `pdf`, `devops-docs`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Criar teste que extrai texto do PDF técnico gerado e verifica ausência de padrão monetário (R$, valor, preço, total) em `BudgetPdfServiceTest`.
...
- [ ] Implementar a alteração necessária em `BudgetPdfServiceTest`
...
1. A funcionalidade descrita em `T053` deve estar completamente implementada no arquivo alvo.
