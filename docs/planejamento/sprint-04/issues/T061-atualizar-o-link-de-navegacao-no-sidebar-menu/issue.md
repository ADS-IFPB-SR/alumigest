# [T061] Atualizar o link de navegação no sidebar/menu do frontend para incluir "Orçamentos" com ícone Lucide
...
Atualizar o link de navegação no sidebar/menu do frontend para incluir "Orçamentos" com ícone Lucide.
...
1. A funcionalidade descrita em `T061` deve estar completamente implementada no arquivo alvo.
