# [US-09.3] Criar migration Flyway `backend/src/main/resources/db/migration/V8__create_budgets_schema.sql` com tabelas `budgets` e `budget_itemsconstraints, índices e checks conforme `data-model.md`
...
- **Labels Sugeridas**: `release-1`, `backend`, `java`, `database`

---

## 🎯 Objetivo & Descrição

Criar migration Flyway `backend/src/main/resources/db/migration/V8__create_budgets_schema.sql` com tabelas `budgets` e `budget_itemsconstraints, índices e checks conforme `data-model.md`.
