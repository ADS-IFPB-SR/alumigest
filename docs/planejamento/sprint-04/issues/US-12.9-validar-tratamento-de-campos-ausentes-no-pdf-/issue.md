...
- **Labels Sugeridas**: `sprint-04`, `release-1`, `pdf`

---

## 🎯 Objetivo & Descrição

Validar tratamento de campos ausentes no PDF (cliente sem CPF/endereço → exibir "Não informado").
...
1. A funcionalidade descrita em `T063` deve estar completamente implementada no arquivo alvo.
