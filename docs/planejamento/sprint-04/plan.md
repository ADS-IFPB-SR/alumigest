# Implementation Plan: Sprint 4 — Descontos e Orçamentos
...
Implementar o módulo completo de descontos comerciais (percentual e valor fixo), condições de pagamento pré-configuradas.
