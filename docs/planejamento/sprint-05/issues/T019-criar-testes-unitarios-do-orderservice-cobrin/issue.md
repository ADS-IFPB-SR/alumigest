# [T019] Criar testes unitários do `OrderService` cobrindo conversão bem-sucedida, bloqueio de conversão duplicada e teste de imutabilidade de itens em `backend/src/test/java/br/edu/ifpb/alumigest/orders/service/OrderServiceTest.java`
...
- **Arquivo / Alvo Principal**: `backend/src/test/java/br/edu/ifpb/alumigest/orders/service/OrderServiceTest.java`
- **Labels Sugeridas**: `sprint-05`, `release-2`, `orders`, `backend`, `java`, `testing`, `mvp`, `user-story-1`

---

## 🎯 Objetivo & Descrição

Criar testes unitários do `OrderService` cobrindo conversão bem-sucedida, bloqueio de conversão duplicada e teste de imutabilidade de itens em `backend/src/test/java/br/edu/ifpb/alumigest/orders/service/OrderServiceTest.java`.
...
- [ ] Implementar a alteração necessária em `backend/src/test/java/br/edu/ifpb/alumigest/orders/service/OrderServiceTest.java`
