# [T021] Criar interfaces TypeScript (Order, OrderItem, OrderConvertRequest, etc.) em `frontend/src/features/orders/types/order.ts`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/orders/types/order.ts`
...
Criar interfaces TypeScript (Order, OrderItem, OrderConvertRequest, etc.) em `frontend/src/features/orders/types/order.ts`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/orders/types/order.ts`
