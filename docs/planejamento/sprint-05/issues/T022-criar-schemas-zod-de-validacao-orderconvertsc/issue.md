# [T022] Criar schemas Zod de validação (orderConvertSchema) em `frontend/src/features/orders/schemas/orderSchema.ts`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/orders/schemas/orderSchema.ts`
- **Labels Sugeridas**: `sprint-05`, `release-2`, `orders`, `frontend`, `typescript`, `react`, `database`, `mvp`, `user-story-1`

---

## 🎯 Objetivo & Descrição

Criar schemas Zod de validação (orderConvertSchema) em `frontend/src/features/orders/schemas/orderSchema.ts`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/orders/schemas/orderSchema.ts`
