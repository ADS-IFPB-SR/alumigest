# [T023] Criar serviço de API Axios em `frontend/src/features/orders/services/orderApi.ts`
...
Criar serviço de API Axios em `frontend/src/features/orders/services/orderApi.ts`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/orders/services/orderApi.ts`
