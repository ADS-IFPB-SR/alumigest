# [T024] Criar custom hooks React Query (useOrders, useOrder, useConvertBudget) em `frontend/src/features/orders/hooks/useOrders.ts`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/orders/hooks/useOrders.ts`
...
Criar custom hooks React Query (useOrders, useOrder, useConvertBudget) em `frontend/src/features/orders/hooks/useOrders.ts`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/orders/hooks/useOrders.ts`
