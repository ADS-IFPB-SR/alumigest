# [T026] Integrar o botão "Aprovar e Gerar Pedido" na tela de detalhes do orçamento (`BudgetDetailPage.tsx`) abrindo o modal de aprovação
...
- **Arquivo / Alvo Principal**: `BudgetDetailPage.tsx`
...
Integrar o botão "Aprovar e Gerar Pedido" na tela de detalhes do orçamento (`BudgetDetailPage.tsx`) abrindo o modal de aprovação.
...
- [ ] Implementar a alteração necessária em `BudgetDetailPage.tsx`
