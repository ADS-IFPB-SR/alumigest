# [T027] Criar componente `OrderStatusBadge` em `frontend/src/features/orders/components/OrderStatusBadge.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/orders/components/OrderStatusBadge.tsx`
...
Criar componente `OrderStatusBadge` em `frontend/src/features/orders/components/OrderStatusBadge.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/orders/components/OrderStatusBadge.tsx`
