# [T028] Criar componente `OrderItemsTable` exibindo a tabela dos itens contratados com valores congelados em `frontend/src/features/orders/components/OrderItemsTable.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/orders/components/OrderItemsTable.tsx`
...
Criar componente `OrderItemsTable` exibindo a tabela dos itens contratados com valores congelados em `frontend/src/features/orders/components/OrderItemsTable.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/orders/components/OrderItemsTable.tsx`
