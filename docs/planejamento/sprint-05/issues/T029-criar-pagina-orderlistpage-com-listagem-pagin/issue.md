# [T029] Criar página `OrderListPage` com listagem paginada, busca e filtros em `frontend/src/pages/OrderListPage.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/pages/OrderListPage.tsx`
...
Criar página `OrderListPage` com listagem paginada, busca e filtros em `frontend/src/pages/OrderListPage.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/pages/OrderListPage.tsx`
