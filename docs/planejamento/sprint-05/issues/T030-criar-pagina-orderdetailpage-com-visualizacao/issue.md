# [T030] Criar página `OrderDetailPage` com visualização detalhada do pedido em `frontend/src/pages/OrderDetailPage.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/pages/OrderDetailPage.tsx`
...
Criar página `OrderDetailPage` com visualização detalhada do pedido em `frontend/src/pages/OrderDetailPage.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/pages/OrderDetailPage.tsx`
