# [T035] Criar modal `OrderCancelModal` com campo de justificativa no frontend em `frontend/src/features/orders/components/OrderCancelModal.tsx`
...
- **Labels Sugeridas**: `sprint-05`, `release-2`, `orders`, `frontend`, `typescript`, `react`, `user-story-3`, `cancellation`
