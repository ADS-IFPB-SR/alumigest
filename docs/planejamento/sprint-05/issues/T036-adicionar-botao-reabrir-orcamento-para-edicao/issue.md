# [T036] Adicionar botão "Reabrir Orçamento para Edição" na tela do orçamento quando o pedido vinculado estiver cancelado
...
- **Labels Sugeridas**: `sprint-05`, `release-2`, `orders`, `user-story-3`, `cancellation`

---

## 🎯 Objetivo & Descrição

Adicionar botão "Reabrir Orçamento para Edição" na tela do orçamento quando o pedido vinculado estiver cancelado.
