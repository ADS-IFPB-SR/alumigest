...
- **Arquivo / Alvo Principal**: `backend/src/main/java/br/edu/ifpb/alumigest/orders/domain/OrderItem.java`
- **Labels Sugeridas**: `sprint-05`, `release-2`, `orders`, `backend`, `java`, `price-lock`

---

## 🎯 Objetivo & Descrição

Criar entidade JPA `OrderItem` com snapshot imutável de itens em `backend/src/main/java/br/edu/ifpb/alumigest/orders/domain/OrderItem.java`.
...
- [ ] Implementar a alteração necessária em `backend/src/main/java/br/edu/ifpb/alumigest/orders/domain/OrderItem.java`
