# [T002] Adicionar dependência `html5-qrcode` no `frontend/package.json`
...
- **Arquivo / Alvo Principal**: `frontend/package.json`
- **Labels Sugeridas**: `sprint-06`, `release-2`, `production`, `frontend`, `typescript`, `react`, `qr-code`

---

## 🎯 Objetivo & Descrição

Adicionar dependência `html5-qrcode` no `frontend/package.json`.
...
- [ ] Implementar a alteração necessária em `frontend/package.json`
