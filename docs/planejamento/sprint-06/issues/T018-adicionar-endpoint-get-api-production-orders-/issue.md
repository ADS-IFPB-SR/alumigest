# [T018] Adicionar endpoint GET /api/production-orders/order/{orderId}/labels-pdf no `ProductionOrderController` (retorna application/pdf)
...
- **Labels Sugeridas**: `sprint-06`, `release-2`, `production`, `backend`, `java`, `pdf`, `labels`, `mvp`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Adicionar endpoint GET /api/production-orders/order/{orderId}/labels-pdf no `ProductionOrderController` (retorna application/pdf).
