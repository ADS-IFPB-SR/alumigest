# [T020] Adicionar botão "Imprimir Etiquetas com QR Code" na tela de detalhes do pedido no frontend (`OrderDetailPage.tsx`)
...
- **Labels Sugeridas**: `sprint-06`, `release-2`, `production`, `frontend`, `typescript`, `react`, `qr-code`, `pdf`, `labels`, `mvp`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Adicionar botão "Imprimir Etiquetas com QR Code" na tela de detalhes do pedido no frontend (`OrderDetailPage.tsx`).
