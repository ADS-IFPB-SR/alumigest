# [T024] Criar interfaces TypeScript e serviço de API Axios (`productionApi.ts`) em `frontend/src/features/production/services/productionApi.ts`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/production/services/productionApi.ts`
- **Labels Sugeridas**: `sprint-06`, `release-2`, `production`, `backend`, `java`, `frontend`, `typescript`, `react`, `mvp`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Criar interfaces TypeScript e serviço de API Axios (`productionApi.ts`) em `frontend/src/features/production/services/productionApi.ts`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/production/services/productionApi.ts`
