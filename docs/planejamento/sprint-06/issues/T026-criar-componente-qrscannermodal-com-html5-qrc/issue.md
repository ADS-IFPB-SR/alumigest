# [T026] Criar componente `QrScannerModal` com `html5-qrcode` para leitura via câmera traseira do dispositivo em `frontend/src/features/production/components/QrScannerModal.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/production/components/QrScannerModal.tsx`
- **Labels Sugeridas**: `sprint-06`, `release-2`, `production`, `frontend`, `typescript`, `react`, `qr-code`, `mvp`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Criar componente `QrScannerModal` com `html5-qrcode` para leitura via câmera traseira do dispositivo em `frontend/src/features/production/components/QrScannerModal.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/production/components/QrScannerModal.tsx`
