# [T027] Criar página `ProductionScannerPage` para operação rápida de chão de fábrica com bipagem e seleção de operador em `frontend/src/pages/ProductionScannerPage.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/pages/ProductionScannerPage.tsx`
...
Criar página `ProductionScannerPage` para operação rápida de chão de fábrica com bipagem e seleção de operador em `frontend/src/pages/ProductionScannerPage.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/pages/ProductionScannerPage.tsx`
