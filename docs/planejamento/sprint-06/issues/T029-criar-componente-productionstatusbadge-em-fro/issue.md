# [T029] Criar componente `ProductionStatusBadge` em `frontend/src/features/production/components/ProductionStatusBadge.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/production/components/ProductionStatusBadge.tsx`
...
Criar componente `ProductionStatusBadge` em `frontend/src/features/production/components/ProductionStatusBadge.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/production/components/ProductionStatusBadge.tsx`
