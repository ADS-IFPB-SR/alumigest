# [T030] Criar componente `ProductionOrderCard` em `frontend/src/features/production/components/ProductionOrderCard.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/production/components/ProductionOrderCard.tsx`
...
Criar componente `ProductionOrderCard` em `frontend/src/features/production/components/ProductionOrderCard.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/production/components/ProductionOrderCard.tsx`
...
1. A funcionalidade descrita em `T030` deve estar completamente implementada no arquivo alvo.
