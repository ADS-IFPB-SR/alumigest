# [T032] Criar página `ProductionKanbanPage` com filtros de busca e botão de atalho para o Scanner em `frontend/src/pages/ProductionKanbanPage.tsx`
...
- **Labels Sugeridas**: `sprint-06`, `release-2`, `production`, `frontend`, `typescript`, `react`, `qr-code`, `user-story-4`, `kanban`

---

## 🎯 Objetivo & Descrição

Criar página `ProductionKanbanPage` com filtros de busca e botão de atalho para o Scanner em `frontend/src/pages/ProductionKanbanPage.tsx`.
