# [T035] Adicionar atalhos de "Chão de Fábrica" e "Scanner QR" no menu lateral do frontend
...
Adicionar atalhos de "Chão de Fábrica" e "Scanner QR" no menu lateral do frontend.
