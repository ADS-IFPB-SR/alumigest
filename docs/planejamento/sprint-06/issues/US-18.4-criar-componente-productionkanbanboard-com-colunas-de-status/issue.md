# [US-18.4] Criar componente `ProductionKanbanBoard` com colunas (`AGUARDANDO_PRODUCAO`EM_PRODUCAO`CONCLUIDO`)

## 📌 Metadados da Issue

- **ID da Tarefa**: `US-18.4`
...
- **Labels Sugeridas**: `release-2`, `production`, `frontend`, `react`, `kanban`

---

## 🎯 Objetivo & Descrição

Montar layout do quadro Kanban com contadores por coluna e lista rolável de cartões.
...
1. Colunas claras e organizadas com contagem em tempo real de pedidos em cada etapa.
