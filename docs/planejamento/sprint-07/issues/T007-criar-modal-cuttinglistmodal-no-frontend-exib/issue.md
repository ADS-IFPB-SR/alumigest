# [T007] Criar modal `CuttingListModal` no frontend exibindo a tabela consolidada de corte em `frontend/src/features/production/components/CuttingListModal.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/production/components/CuttingListModal.tsx`
- **Labels Sugeridas**: `sprint-07`, `release-2`, `cutting-list`, `frontend`, `typescript`, `react`, `mvp`, `user-story-1`

---

## 🎯 Objetivo & Descrição

Criar modal `CuttingListModal` no frontend exibindo a tabela consolidada de corte em `frontend/src/features/production/components/CuttingListModal.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/production/components/CuttingListModal.tsx`
