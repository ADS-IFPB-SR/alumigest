# [T008] Adicionar botão "Lista de Corte" na tela de detalhes do pedido (`OrderDetailPage.tsx`)
...
Adicionar botão "Lista de Corte" na tela de detalhes do pedido (`OrderDetailPage.tsx`).
