# [T009] Implementar método `gerarFichaMontagem(Long productionOrderId)` no `CuttingListService`
...
Implementar método `gerarFichaMontagem(Long productionOrderId)` no `CuttingListService`.
