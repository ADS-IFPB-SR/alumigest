# [T010] Adicionar endpoint GET /api/production/production-orders/{id}/assembly-sheet no `ProductionReportController`
...
- **Labels Sugeridas**: `sprint-07`, `release-2`, `cutting-list`, `backend`, `java`, `mvp`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Adicionar endpoint GET /api/production/production-orders/{id}/assembly-sheet no `ProductionReportController`.
