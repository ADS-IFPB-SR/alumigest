# [T012] Integrar a visualização da Ficha Técnica na página de detalhes da OP (`ProductionOrderDetailPage.tsx`) e após leitura no scanner
...
- **Arquivo / Alvo Principal**: `ProductionOrderDetailPage.tsx`
...
Integrar a visualização da Ficha Técnica na página de detalhes da OP (`ProductionOrderDetailPage.tsx`) e após leitura no scanner.
...
- [ ] Implementar a alteração necessária em `ProductionOrderDetailPage.tsx`
