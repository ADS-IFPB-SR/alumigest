# [T014] Adicionar método para gerar PDF individual da Ficha Técnica da OP no `WorkshopPdfService`
...
Adicionar método para gerar PDF individual da Ficha Técnica da OP no `WorkshopPdfService`.
