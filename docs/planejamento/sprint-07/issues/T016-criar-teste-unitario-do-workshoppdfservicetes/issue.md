# [T016] Criar teste unitário do `WorkshopPdfServiceTest` validando geração de bytes não-vazios
...
- **Labels Sugeridas**: `sprint-07`, `release-2`, `cutting-list`, `backend`, `java`, `testing`, `pdf`, `reports`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Criar teste unitário do `WorkshopPdfServiceTest` validando geração de bytes não-vazios.
