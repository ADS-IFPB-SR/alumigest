# [T017] Adicionar botões de download do PDF na interface do frontend
...
- **Labels Sugeridas**: `sprint-07`, `release-2`, `cutting-list`, `frontend`, `typescript`, `react`, `pdf`, `reports`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Adicionar botões de download do PDF na interface do frontend.
