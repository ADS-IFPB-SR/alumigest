# [US-19.4] Implementar serviço `CuttingListService.gerarRomaneioPedido(Long orderId)` agregando dados das OPs e itens do pedido em `backend/src/main/java/br/edu/ifpb/alumigest/production/service/CuttingListService.java`
...
- **Labels Sugeridas**: `release-2`, `cutting-list`, `backend`, `java`, `pdf`, `reports`, `mvp`, `user-story-1`
