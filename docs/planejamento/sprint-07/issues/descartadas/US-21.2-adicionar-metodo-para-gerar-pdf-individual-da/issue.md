# [US-21.2] Adicionar método para gerar PDF individual da Ficha Técnica do Item no `WorkshopPdfService`
...
- **Arquivo / Alvo Principal**: `WorkshopPdfService`
...
Adicionar método para gerar PDF individual da Ficha Técnica do Item no `WorkshopPdfService`.
...
- [ ] Implementar a alteração necessária em `WorkshopPdfService`
