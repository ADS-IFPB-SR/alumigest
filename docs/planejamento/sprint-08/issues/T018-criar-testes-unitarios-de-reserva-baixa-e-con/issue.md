# [T018] Criar testes unitários de reserva, baixa e concorrência no `StockServiceTest` em `backend/src/test/java/br/edu/ifpb/alumigest/stock/service/StockServiceTest.java`
...
- **Arquivo / Alvo Principal**: `StockServiceTest`
- **Labels Sugeridas**: `sprint-08`, `release-2`, `stock`, `backend`, `java`, `testing`, `mvp`, `user-story-1`

---

## 🎯 Objetivo & Descrição

Criar testes unitários de reserva, baixa e concorrência no `StockServiceTest` em `backend/src/test/java/br/edu/ifpb/alumigest/stock/service/StockServiceTest.java`.
...
- [ ] Implementar a alteração necessária em `StockServiceTest`
