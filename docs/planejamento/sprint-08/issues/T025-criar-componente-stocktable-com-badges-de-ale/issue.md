# [T025] Criar componente `StockTable` com badges de alerta amarelo em `frontend/src/features/stock/components/StockTable.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/stock/components/StockTable.tsx`
...
Criar componente `StockTable` com badges de alerta amarelo em `frontend/src/features/stock/components/StockTable.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/stock/components/StockTable.tsx`
