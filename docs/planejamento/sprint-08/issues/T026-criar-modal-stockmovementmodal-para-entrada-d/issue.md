# [T026] Criar modal `StockMovementModal` para entrada de materiais em `frontend/src/features/stock/components/StockMovementModal.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/stock/components/StockMovementModal.tsx`
- **Labels Sugeridas**: `sprint-08`, `release-2`, `stock`, `frontend`, `typescript`, `react`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Criar modal `StockMovementModal` para entrada de materiais em `frontend/src/features/stock/components/StockMovementModal.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/stock/components/StockMovementModal.tsx`
