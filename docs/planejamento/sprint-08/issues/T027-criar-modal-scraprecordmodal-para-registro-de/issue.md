# [T027] Criar modal `ScrapRecordModal` para registro de perda/sucata em `frontend/src/features/stock/components/ScrapRecordModal.tsx`
...
- **Labels Sugeridas**: `sprint-08`, `release-2`, `stock`, `frontend`, `typescript`, `react`, `scrap`, `user-story-3`
