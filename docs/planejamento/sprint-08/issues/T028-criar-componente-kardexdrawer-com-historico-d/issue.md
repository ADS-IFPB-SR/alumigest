# [T028] Criar componente `KardexDrawer` com histórico de movimentações em `frontend/src/features/stock/components/KardexDrawer.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/stock/components/KardexDrawer.tsx`
...
Criar componente `KardexDrawer` com histórico de movimentações em `frontend/src/features/stock/components/KardexDrawer.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/stock/components/KardexDrawer.tsx`
