# [T030] Executar `mvn clean verify` no backend e corrigir qualquer falha nos testes de todas as sprints da Release 2
...
- **Labels Sugeridas**: `sprint-08`, `release-2`, `stock`, `backend`, `java`, `testing`, `user-story-4`, `homologation`

---

## 🎯 Objetivo & Descrição

Executar `mvn clean verify` no backend e corrigir qualquer falha nos testes de todas as sprints da Release 2.
