# [T032] Validar os cenários E2E da Release 2 no ambiente local
...
- **Labels Sugeridas**: `sprint-08`, `release-2`, `stock`, `user-story-4`, `homologation`

---

## 🎯 Objetivo & Descrição

Validar os cenários E2E da Release 2 no ambiente local.
