# [US-20.4] Integrar a visualização da Ficha Técnica na página de detalhes do Item (`OrderDetailPage.tsx`) e após leitura no scanner
...
Integrar a visualização da Ficha Técnica na página de detalhes do Item (`OrderDetailPage.tsx`) e após leitura no scanner.
