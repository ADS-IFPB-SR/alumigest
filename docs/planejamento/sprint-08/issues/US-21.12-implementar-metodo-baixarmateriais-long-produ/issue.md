# [US-21.12] Implementar método `baixarMateriais(Long productionOrderId)` no `StockService` convertendo reserva em baixa física

## 📌 Metadados da Issue

- **ID da Tarefa**: `US-21.12`
...
- **Arquivo / Alvo Principal**: `StockService`
...
Implementar método `baixarMateriais(Long productionOrderId)` no `StockService` convertendo reserva em baixa física.
...
- [ ] Implementar a alteração necessária em `StockService`
