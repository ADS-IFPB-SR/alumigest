# [US-21.2] Criar migration Flyway `backend/src/main/resources/db/migration/V11__create_stock_schema.sql` com tabelas `stock_items`stock_movements` e ``

## 📌 Metadados da Issue

- **ID da Tarefa**: `US-21.2`
...
- **Arquivo / Alvo Principal**: `backend/src/main/resources/db/migration/V11__create_stock_schema.sql`
- **Labels Sugeridas**: `release-2`, `stock`, `backend`, `java`, `database`, `scrap`

---

## 🎯 Objetivo & Descrição

Criar migration Flyway `backend/src/main/resources/db/migration/V11__create_stock_schema.sql` com tabelas `stock_items`stock_movements` e ``.
...
- [ ] Implementar a alteração necessária em `backend/src/main/resources/db/migration/V11__create_stock_schema.sql`
