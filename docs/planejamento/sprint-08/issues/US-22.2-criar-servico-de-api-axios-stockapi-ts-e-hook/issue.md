...
- **Arquivo / Alvo Principal**: `stockApi.ts`
...
Criar serviço de API Axios (`stockApi.ts`) e hooks React Query (`useStock.ts`).
...
- [ ] Implementar a alteração necessária em `stockApi.ts`
