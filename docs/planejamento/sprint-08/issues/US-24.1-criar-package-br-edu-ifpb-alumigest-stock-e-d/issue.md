...
- **Arquivo / Alvo Principal**: `br.edu.ifpb.alumigest.stock`
- **Labels Sugeridas**: `sprint-08`, `release-2`, `stock`, `frontend`, `typescript`, `react`

---

## 🎯 Objetivo & Descrição

Criar package `br.edu.ifpb.alumigest.stock` e diretório `frontend/src/features/stock`.
...
- [ ] Implementar a alteração necessária em `br.edu.ifpb.alumigest.stock`
