# [US-22.4] Criar enum `ScrapReason` (QUEBRA_MANUSEIO, ERRO_MEDIDA_CORTE, DEFEITO_FABRICA_MATERIAL, AVARIA_TRANSPORTE, OUTROS) em `backend/src/main/java/br/edu/ifpb/alumigest/stock/domain/ScrapReason.java`

## 📌 Metadados da Issue

- **ID da Tarefa**: `US-22.4`
- **US Pai**: `US-22: Reservar e Baixar Matéria-Prima no Estoque Automaticamente`
...
- **Arquivo / Alvo Principal**: `backend/src/main/java/br/edu/ifpb/alumigest/stock/domain/ScrapReason.java`
- **Labels Sugeridas**: `release-2`, `stock`, `backend`, `java`, `scrap`

---

## 🎯 Objetivo & Descrição

Criar enum `ScrapReason` (QUEBRA_MANUSEIO, ERRO_MEDIDA_CORTE, DEFEITO_FABRICA_MATERIAL, AVARIA_TRANSPORTE, OUTROS) em `backend/src/main/java/br/edu/ifpb/alumigest/stock/domain/ScrapReason.java`.
...
- [ ] Implementar a alteração necessária em `backend/src/main/java/br/edu/ifpb/alumigest/stock/domain/ScrapReason.java`
