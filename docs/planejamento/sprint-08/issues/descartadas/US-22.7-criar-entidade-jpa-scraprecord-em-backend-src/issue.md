# [US-22.7] Criar entidade JPA `ScrapRecord` em `backend/src/main/java/br/edu/ifpb/alumigest/stock/domain/ScrapRecord.java`

## 📌 Metadados da Issue

- **ID da Tarefa**: `US-22.7`
...
- **Arquivo / Alvo Principal**: `backend/src/main/java/br/edu/ifpb/alumigest/stock/domain/ScrapRecord.java`
...
Criar entidade JPA `ScrapRecord` em `backend/src/main/java/br/edu/ifpb/alumigest/stock/domain/ScrapRecord.java`.
...
- [ ] Implementar a alteração necessária em `backend/src/main/java/br/edu/ifpb/alumigest/stock/domain/ScrapRecord.java`
