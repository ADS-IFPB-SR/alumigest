# [US-24.5] Criar modal `ScrapRecordModal` para registro de perda/sucata em `frontend/src/features/stock/components/ScrapRecordModal.tsx`

## 📌 Metadados da Issue

- **ID da Tarefa**: `US-24.5`
- **US Pai**: `US-24: Consultar Posição de Estoque e Kardex de Movimentações`
- **Release**: Release 2 (v2.0.0) — Gestão de Produção & Fábrica
- **Fase**: `Phase 4: User Story 3 - Painel de Posição de Estoque no Frontend (Priority: P2)`
- **User Story**: [US3]
- **Sub-área**: `Geral`
- **Execução Paralela**: ❌ Não (Execução sequencial recomendada)
- **Arquivo / Alvo Principal**: `frontend/src/features/stock/components/ScrapRecordModal.tsx`
- **Labels Sugeridas**: `release-2`, `stock`, `frontend`, `typescript`, `react`, `scrap`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Criar modal `ScrapRecordModal` para registro de perda/sucata em `frontend/src/features/stock/components/ScrapRecordModal.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/stock/components/ScrapRecordModal.tsx`
