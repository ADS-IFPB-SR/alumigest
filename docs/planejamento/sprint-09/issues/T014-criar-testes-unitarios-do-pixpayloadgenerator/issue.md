# [T014] Criar testes unitários do `PixPayloadGeneratorTest` e `PixServiceTest`
...
- **Labels Sugeridas**: `sprint-09`, `release-3`, `pix`, `finance`, `backend`, `java`, `testing`, `mvp`, `user-story-1`

---

## 🎯 Objetivo & Descrição

Criar testes unitários do `PixPayloadGeneratorTest` e `PixServiceTest`.
