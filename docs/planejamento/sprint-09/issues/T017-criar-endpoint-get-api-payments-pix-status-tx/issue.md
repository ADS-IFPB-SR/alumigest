# [T017] Criar endpoint GET /api/payments/pix/status/{txid} no `PixPaymentController` para polling de status
...
Criar endpoint GET /api/payments/pix/status/{txid} no `PixPaymentController` para polling de status.
