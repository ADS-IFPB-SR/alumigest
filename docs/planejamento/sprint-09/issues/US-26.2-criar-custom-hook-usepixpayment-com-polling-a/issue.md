...
- **Arquivo / Alvo Principal**: `frontend/src/features/finance/hooks/usePixPayment.ts`
...
Criar custom hook `usePixPayment` com polling automático a cada 3 segundos em `frontend/src/features/finance/hooks/usePixPayment.ts`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/finance/hooks/usePixPayment.ts`
