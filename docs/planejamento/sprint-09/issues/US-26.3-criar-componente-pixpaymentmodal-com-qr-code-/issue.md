...
- **Arquivo / Alvo Principal**: `frontend/src/features/finance/components/PixPaymentModal.tsx`
...
Criar componente `PixPaymentModal` com QR Code, botão "Copiar Chave PIX" e timer regressivo em `frontend/src/features/finance/components/PixPaymentModal.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/finance/components/PixPaymentModal.tsx`
