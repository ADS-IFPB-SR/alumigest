...
- **Arquivo / Alvo Principal**: `br.edu.ifpb.alumigest.finance`
- **Labels Sugeridas**: `sprint-09`, `release-3`, `pix`, `finance`, `frontend`, `typescript`, `react`

---

## 🎯 Objetivo & Descrição

Criar package `br.edu.ifpb.alumigest.finance` e diretório `frontend/src/features/finance`.
...
- [ ] Implementar a alteração necessária em `br.edu.ifpb.alumigest.finance`
