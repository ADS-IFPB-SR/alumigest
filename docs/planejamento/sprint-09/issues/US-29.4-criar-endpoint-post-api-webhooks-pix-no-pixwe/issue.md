...
- **US Pai**: `US-29: Confirmar Pagamento PIX via Webhook com Liberação Automática`
...
- **Arquivo / Alvo Principal**: `PixWebhookController`
- **Labels Sugeridas**: `sprint-09`, `release-3`, `pix`, `finance`, `backend`, `java`, `frontend`, `typescript`, `react`, `webhook`, `mvp`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Criar endpoint POST /api/webhooks/pix no `PixWebhookController`.
...
- [ ] Implementar a alteração necessária em `PixWebhookController`
