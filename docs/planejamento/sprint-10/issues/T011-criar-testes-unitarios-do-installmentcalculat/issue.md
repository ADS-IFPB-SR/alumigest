# [T011] Criar testes unitários do `InstallmentCalculatorTest` e `AccountReceivableServiceTest`
...
- **Labels Sugeridas**: `sprint-10`, `release-3`, `finance`, `receivables`, `backend`, `java`, `testing`, `mvp`, `user-story-1`

---

## 🎯 Objetivo & Descrição

Criar testes unitários do `InstallmentCalculatorTest` e `AccountReceivableServiceTest`.
