# [T013] Criar endpoint GET /api/finance/receivables no `AccountReceivableController`
...
- **Labels Sugeridas**: `sprint-10`, `release-3`, `finance`, `receivables`, `backend`, `java`, `mvp`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Criar endpoint GET /api/finance/receivables no `AccountReceivableController`.
