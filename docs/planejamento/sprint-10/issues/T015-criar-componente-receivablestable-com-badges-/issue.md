# [T015] Criar componente `ReceivablesTable` com badges de alerta de vencimento em `frontend/src/features/finance/components/ReceivablesTable.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/finance/components/ReceivablesTable.tsx`
- **Labels Sugeridas**: `sprint-10`, `release-3`, `finance`, `receivables`, `frontend`, `typescript`, `react`, `mvp`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Criar componente `ReceivablesTable` com badges de alerta de vencimento em `frontend/src/features/finance/components/ReceivablesTable.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/finance/components/ReceivablesTable.tsx`
