# [T021] Criar teste unitário do `ReceiptPdfServiceTest`
...
- **Labels Sugeridas**: `sprint-10`, `release-3`, `finance`, `receivables`, `backend`, `java`, `testing`, `pdf`, `receipts`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Criar teste unitário do `ReceiptPdfServiceTest`.
