# [T022] Criar componente `ClientFinancialStatementCard` no frontend
...
- **Labels Sugeridas**: `sprint-10`, `release-3`, `finance`, `receivables`, `frontend`, `typescript`, `react`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Criar componente `ClientFinancialStatementCard` no frontend.
