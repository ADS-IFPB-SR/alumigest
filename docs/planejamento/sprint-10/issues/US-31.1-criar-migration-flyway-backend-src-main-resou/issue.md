...
- **Arquivo / Alvo Principal**: `backend/src/main/resources/db/migration/V13__create_account_receivables_schema.sql`
- **Labels Sugeridas**: `sprint-10`, `release-3`, `finance`, `receivables`, `backend`, `java`, `database`

---

## 🎯 Objetivo & Descrição

Criar migration Flyway `backend/src/main/resources/db/migration/V13__create_account_receivables_schema.sql` com tabela `account_receivables`.
...
- [ ] Implementar a alteração necessária em `backend/src/main/resources/db/migration/V13__create_account_receivables_schema.sql`
