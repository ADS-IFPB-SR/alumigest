# [T008] Criar modal `SettlementModal` no frontend com campos de valor, desconto e método de pagamento em `frontend/src/features/finance/components/SettlementModal.tsx`
...
- **Labels Sugeridas**: `sprint-11`, `release-3`, `finance`, `cash-flow`, `frontend`, `typescript`, `react`, `mvp`, `user-story-1`
