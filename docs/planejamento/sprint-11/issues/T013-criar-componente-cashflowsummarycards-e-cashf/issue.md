# [T013] Criar componente `CashFlowSummaryCards` e `CashFlowProjectionChart` no frontend em `frontend/src/features/finance/components/`
...
- **Labels Sugeridas**: `sprint-11`, `release-3`, `finance`, `cash-flow`, `frontend`, `typescript`, `react`, `mvp`, `user-story-2`
