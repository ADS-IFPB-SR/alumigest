# [US] Criar migration Flyway `backend/src/main/resources/db/migration/V14__create_cash_flows_schema.sql` com tabela `cash_flows`
...
- **Labels Sugeridas**: `release-3`, `finance`, `cash-flow`, `backend`, `java`, `database`
