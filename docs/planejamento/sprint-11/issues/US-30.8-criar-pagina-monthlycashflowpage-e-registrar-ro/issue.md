# [US] Criar página `CashFlowPage` e registrar rota `/financeiro/fluxo-de-caixa` no React Router
...
Criar página `CashFlowPage` e registrar rota `/financeiro/fluxo-de-caixa` no React Router.
