# [US-32.7] Criar testes unitários do `SettlementServiceTest`

## 📌 Metadados da Issue

- **ID da Tarefa**: `US-32.7`
...
- **Labels Sugeridas**: `release-3`, `finance`, `cash-flow`, `backend`, `java`, `testing`, `mvp`, `user-story-1`
