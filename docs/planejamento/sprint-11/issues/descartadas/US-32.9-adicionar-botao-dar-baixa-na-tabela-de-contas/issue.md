# [US-32.9] Adicionar botão "Dar Baixa" na tabela de Contas a Receber (`ReceivablesTable.tsx`)

## 📌 Metadados da Issue

- **ID da Tarefa**: `US-32.9`
...
- **Arquivo / Alvo Principal**: `ReceivablesTable.tsx`
...
Adicionar botão "Dar Baixa" na tabela de Contas a Receber (`ReceivablesTable.tsx`).
...
- [ ] Implementar a alteração necessária em `ReceivablesTable.tsx`
