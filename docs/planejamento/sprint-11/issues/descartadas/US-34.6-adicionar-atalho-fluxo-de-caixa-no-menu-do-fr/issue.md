# [US-34.6] Adicionar atalho "Fluxo de Caixa" no menu do frontend

## 📌 Metadados da Issue

- **ID da Tarefa**: `US-34.6`
...
- **Labels Sugeridas**: `release-3`, `finance`, `cash-flow`, `frontend`, `typescript`, `react`

---

## 🎯 Objetivo & Descrição

Adicionar atalho "Fluxo de Caixa" no menu do frontend.
