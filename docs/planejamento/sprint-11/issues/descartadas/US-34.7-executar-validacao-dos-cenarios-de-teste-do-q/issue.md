# [US-34.7] Executar validação dos cenários de teste do `quickstart.md` da Sprint 11
...
- **Labels Sugeridas**: `release-3`, `finance`, `cash-flow`, `testing`

---

## 🎯 Objetivo & Descrição

Executar validação dos cenários de teste do `quickstart.md` da Sprint 11.
