# [T010] Criar testes unitários do `ServiceOrderServiceTest`
...
- **Labels Sugeridas**: `sprint-12`, `release-3`, `installation`, `field-service`, `backend`, `java`, `testing`, `mvp`, `user-story-1`
