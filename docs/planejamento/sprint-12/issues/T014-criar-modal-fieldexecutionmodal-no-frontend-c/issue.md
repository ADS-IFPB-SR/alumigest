# [T014] Criar modal `FieldExecutionModal` no frontend com upload de câmera do celular em `frontend/src/features/installation/components/FieldExecutionModal.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/installation/components/FieldExecutionModal.tsx`
- **Labels Sugeridas**: `sprint-12`, `release-3`, `installation`, `field-service`, `frontend`, `typescript`, `react`, `mvp`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Criar modal `FieldExecutionModal` no frontend com upload de câmera do celular em `frontend/src/features/installation/components/FieldExecutionModal.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/installation/components/FieldExecutionModal.tsx`
