# [T016] Implementar serviço `CalendarService.obterEventosMes(int mes, int ano, Long teamId)`
...
Implementar serviço `CalendarService.obterEventosMes(int mes, int ano, Long teamId)`.
