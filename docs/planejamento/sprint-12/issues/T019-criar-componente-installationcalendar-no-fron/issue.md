# [T019] Criar componente `InstallationCalendar` no frontend com código de cores por status em `frontend/src/features/installation/components/InstallationCalendar.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/installation/components/InstallationCalendar.tsx`
...
Criar componente `InstallationCalendar` no frontend com código de cores por status em `frontend/src/features/installation/components/InstallationCalendar.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/installation/components/InstallationCalendar.tsx`
