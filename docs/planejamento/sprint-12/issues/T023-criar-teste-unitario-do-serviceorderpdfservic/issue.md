# [T023] Criar teste unitário do `ServiceOrderPdfServiceTest`
...
- **Labels Sugeridas**: `sprint-12`, `release-3`, `installation`, `field-service`, `backend`, `java`, `testing`, `pdf`, `field-reports`, `user-story-4`
