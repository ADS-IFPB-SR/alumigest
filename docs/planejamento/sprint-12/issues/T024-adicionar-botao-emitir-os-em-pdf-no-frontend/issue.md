# [T024] Adicionar botão "Emitir OS em PDF" no frontend
...
- **Labels Sugeridas**: `sprint-12`, `release-3`, `installation`, `field-service`, `frontend`, `typescript`, `react`, `pdf`, `field-reports`, `user-story-4`

---

## 🎯 Objetivo & Descrição

Adicionar botão "Emitir OS em PDF" no frontend.
