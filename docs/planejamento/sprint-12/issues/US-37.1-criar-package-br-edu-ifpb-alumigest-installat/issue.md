...
- **Arquivo / Alvo Principal**: `br.edu.ifpb.alumigest.installation`
- **Labels Sugeridas**: `sprint-12`, `release-3`, `installation`, `field-service`, `frontend`, `typescript`, `react`

---

## 🎯 Objetivo & Descrição

Criar package `br.edu.ifpb.alumigest.installation` e diretório `frontend/src/features/installation`.
...
- [ ] Implementar a alteração necessária em `br.edu.ifpb.alumigest.installation`
