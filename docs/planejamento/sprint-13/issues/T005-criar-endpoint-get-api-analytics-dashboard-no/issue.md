# [T005] Criar endpoint GET /api/analytics/dashboard no `AnalyticsDashboardController` em `backend/src/main/java/br/edu/ifpb/alumigest/analytics/controller/AnalyticsDashboardController.java`
...
- **Arquivo / Alvo Principal**: `AnalyticsDashboardController`
...
Criar endpoint GET /api/analytics/dashboard no `AnalyticsDashboardController` em `backend/src/main/java/br/edu/ifpb/alumigest/analytics/controller/AnalyticsDashboardController.java`.
...
- [ ] Implementar a alteração necessária em `AnalyticsDashboardController`
