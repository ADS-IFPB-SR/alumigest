# [T013] Criar componente `DreReportTable` com toggle Competência/Caixa no frontend em `frontend/src/features/analytics/components/DreReportTable.tsx`
...
- **Arquivo / Alvo Principal**: `frontend/src/features/analytics/components/DreReportTable.tsx`
- **Labels Sugeridas**: `sprint-13`, `release-3`, `analytics`, `dre`, `dashboard`, `frontend`, `typescript`, `react`, `pdf`, `financial-reports`, `mvp`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Criar componente `DreReportTable` com toggle Competência/Caixa no frontend em `frontend/src/features/analytics/components/DreReportTable.tsx`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/analytics/components/DreReportTable.tsx`
