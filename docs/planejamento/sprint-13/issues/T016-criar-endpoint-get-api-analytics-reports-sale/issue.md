# [T016] Criar endpoint GET /api/analytics/reports/sales-csv e GET /api/analytics/reports/dre-pdf no `AnalyticsReportController`
...
- **Arquivo / Alvo Principal**: `AnalyticsReportController`
- **Labels Sugeridas**: `sprint-13`, `release-3`, `analytics`, `dre`, `dashboard`, `backend`, `java`, `csv`, `export`, `pdf`, `financial-reports`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Criar endpoint GET /api/analytics/reports/sales-csv e GET /api/analytics/reports/dre-pdf no `AnalyticsReportController`.
...
- [ ] Implementar a alteração necessária em `AnalyticsReportController`
