# [T018] Adicionar botões de "Exportar CSV" e "Exportar PDF" nas telas de relatórios do frontend
...
- **Labels Sugeridas**: `sprint-13`, `release-3`, `analytics`, `dre`, `dashboard`, `frontend`, `typescript`, `react`, `csv`, `export`, `pdf`, `financial-reports`, `user-story-3`

---

## 🎯 Objetivo & Descrição

Adicionar botões de "Exportar CSV" e "Exportar PDF" nas telas de relatórios do frontend.
