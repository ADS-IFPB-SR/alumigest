...
- **Arquivo / Alvo Principal**: `br.edu.ifpb.alumigest.analytics`
- **Labels Sugeridas**: `release-3`, `analytics`, `dre`, `dashboard`, `frontend`, `typescript`, `react`

---

## 🎯 Objetivo & Descrição

Criar package `br.edu.ifpb.alumigest.analytics` e diretório `frontend/src/features/analytics`.
...
- [ ] Implementar a alteração necessária em `br.edu.ifpb.alumigest.analytics`
