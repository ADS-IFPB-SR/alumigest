...
- **Labels Sugeridas**: `release-3`, `analytics`, `dre`, `dashboard`, `backend`, `java`, `pdf`, `financial-reports`, `mvp`, `user-story-2`

---

## 🎯 Objetivo & Descrição

Criar endpoint GET /api/analytics/dre no `AnalyticsDashboardController` com validação de permissão administrativa.
