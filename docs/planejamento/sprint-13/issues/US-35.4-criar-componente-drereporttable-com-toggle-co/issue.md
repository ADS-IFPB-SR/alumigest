...
- **US Pai**: `US-35: Apurar DRE Gerencial (Competência e Caixa)`
...
- **Labels Sugeridas**: `release-3`, `analytics`, `dre`, `dashboard`, `frontend`, `typescript`, `react`, `pdf`, `financial-reports`, `mvp`, `user-story-2`
