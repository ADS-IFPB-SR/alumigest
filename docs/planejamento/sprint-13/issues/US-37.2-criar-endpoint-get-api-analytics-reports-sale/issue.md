...
- **US Pai**: `US-37: Exportar Relatórios Executivos em PDF e Planilhas CSV/Excel`
...
- **Labels Sugeridas**: `release-3`, `analytics`, `dre`, `dashboard`, `backend`, `java`, `csv`, `export`, `pdf`, `financial-reports`, `user-story-3`
