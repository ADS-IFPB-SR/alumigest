# [T010] Criar record `SyncBatchRequest` e `SyncBatchResponse` em `backend/src/main/java/br/edu/ifpb/alumigest/sync/dto/`
...
- **Arquivo / Alvo Principal**: `backend/src/main/java/br/edu/ifpb/alumigest/sync/dto/`
- **Labels Sugeridas**: `sprint-14`, `release-3`, `pwa`, `offline`, `performance`, `backend`, `java`, `mvp`, `user-story-2`, `sync`

---

## 🎯 Objetivo & Descrição

Criar record `SyncBatchRequest` e `SyncBatchResponse` em `backend/src/main/java/br/edu/ifpb/alumigest/sync/dto/`.
...
- [ ] Implementar a alteração necessária em `backend/src/main/java/br/edu/ifpb/alumigest/sync/dto/`
