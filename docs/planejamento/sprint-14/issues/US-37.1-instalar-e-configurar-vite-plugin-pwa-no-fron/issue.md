...
- **Arquivo / Alvo Principal**: `frontend/vite.config.ts`
...
Instalar e configurar `vite-plugin-pwa` no `frontend/vite.config.ts` com manifesto, ícones e splash screen.
...
- [ ] Implementar a alteração necessária em `frontend/vite.config.ts`
