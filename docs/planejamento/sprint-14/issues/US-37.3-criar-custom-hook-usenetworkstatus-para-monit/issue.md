...
- **Arquivo / Alvo Principal**: `frontend/src/features/pwa/hooks/useNetworkStatus.ts`
- **Labels Sugeridas**: `release-3`, `pwa`, `offline`, `performance`, `frontend`, `typescript`, `pwa`

---

## 🎯 Objetivo & Descrição

Criar custom hook `useNetworkStatus` para monitorar conectividade em `frontend/src/features/pwa/hooks/useNetworkStatus.ts`.
...
- [ ] Implementar a alteração necessária em `frontend/src/features/pwa/hooks/useNetworkStatus.ts`
