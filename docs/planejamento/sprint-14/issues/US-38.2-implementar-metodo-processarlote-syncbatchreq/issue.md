...
- **Arquivo / Alvo Principal**: `SyncService`
...
Implementar método `processarLote(SyncBatchRequest request)` no `SyncService`.
...
- [ ] Implementar a alteração necessária em `SyncService`
