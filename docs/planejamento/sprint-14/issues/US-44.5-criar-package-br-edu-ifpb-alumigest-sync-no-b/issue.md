...
- **Arquivo / Alvo Principal**: `br.edu.ifpb.alumigest.sync`
...
Criar package `br.edu.ifpb.alumigest.sync` no backend.
...
- [ ] Implementar a alteração necessária em `br.edu.ifpb.alumigest.sync`
