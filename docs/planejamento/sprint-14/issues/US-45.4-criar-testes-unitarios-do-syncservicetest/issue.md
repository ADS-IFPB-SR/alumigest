...
- **Labels Sugeridas**: `sprint-14`, `release-3`, `pwa`, `offline`, `performance`, `backend`, `java`, `testing`, `mvp`, `user-story-2`, `sync`

---

## 🎯 Objetivo & Descrição

Criar testes unitários do `SyncServiceTest`.
