...
- **Labels Sugeridas**: `sprint-14`, `release-3`, `pwa`, `offline`, `performance`, `mvp`, `user-story-2`, `sync`

---

## 🎯 Objetivo & Descrição

Criar componente `SyncQueueDrawer` com lista de ações pendentes e botão "Sincronizar Agora".
