...
- **ID da Tarefa**: `US-46.2`
- **US Pai**: `US-46: Comprimir Imagens no Dispositivo e Otimizar Performance Web`
...
- **Arquivo / Alvo Principal**: `FieldExecutionModal.tsx`
- **Labels Sugeridas**: `sprint-14`, `release-3`, `pwa`, `offline`, `performance`, `frontend`, `typescript`, `pwa`, `image-compression`, `user-story-3`, `optimization`

---

## 🎯 Objetivo & Descrição

Integrar compressão no componente de captura de fotos da OS (`FieldExecutionModal.tsx`).
...
- [ ] Implementar a alteração necessária em `FieldExecutionModal.tsx`
