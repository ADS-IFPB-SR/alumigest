...
- **Arquivo / Alvo Principal**: `React.lazy`
- **Labels Sugeridas**: `sprint-14`, `release-3`, `pwa`, `offline`, `performance`, `frontend`, `typescript`, `pwa`, `user-story-3`, `optimization`

---

## 🎯 Objetivo & Descrição

Configurar code-splitting com `React.lazy` nas rotas do React Router.
...
- [ ] Implementar a alteração necessária em `React.lazy`
