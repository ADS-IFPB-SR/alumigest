# [T020] Criar teste unitário do `OperationalManualPdfServiceTest`
...
- **Labels Sugeridas**: `sprint-15`, `release-3`, `onboarding`, `homologacao-r3`, `backend`, `java`, `testing`, `e2e`, `pdf`, `training`, `user-story-3`, `documentation`
