...
- **Arquivo / Alvo Principal**: `backend/src/main/java/br/edu/ifpb/alumigest/onboarding/dto/`
...
Criar record `ClientImportSummaryResponse` (totalLinhas, importadosComSucesso, duplicadosIgnorados, erros) em `backend/src/main/java/br/edu/ifpb/alumigest/onboarding/dto/`.
...
- [ ] Implementar a alteração necessária em `backend/src/main/java/br/edu/ifpb/alumigest/onboarding/dto/`
