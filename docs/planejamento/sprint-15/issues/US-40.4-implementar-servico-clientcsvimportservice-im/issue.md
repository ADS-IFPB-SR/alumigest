...
- **ID da Tarefa**: `US-40.4`
- **US Pai**: `US-40: Executar Carga Inicial de Dados e Importador de Clientes via CSV`
...
- **Labels Sugeridas**: `release-3`, `onboarding`, `homologacao-r3`, `backend`, `java`, `mvp`, `user-story-1`, `data-seeding`
