...
- **ID da Tarefa**: `US-41.9`
- **US Pai**: `US-41: Homologação Integrada Ponta a Ponta da Release 3 (v3.0.0)`
...
- **Labels Sugeridas**: `release-3`, `onboarding`, `homologacao-r3`, `testing`, `e2e`, `mvp`, `user-story-2`, `acceptance`

---

## 🎯 Objetivo & Descrição

Executar e validar Passo 9: Baixa do Saldo Final 50% em Dinheiro e Fechamento de Caixa (R3 - Sprints 10 e 11).
