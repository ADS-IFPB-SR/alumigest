...
- **Arquivo / Alvo Principal**: `br.edu.ifpb.alumigest.onboarding`
- **Labels Sugeridas**: `sprint-15`, `release-3`, `onboarding`, `homologacao-r3`, `frontend`, `typescript`, `react`

---

## 🎯 Objetivo & Descrição

Criar package `br.edu.ifpb.alumigest.onboarding` e diretório `frontend/src/features/onboarding`.
...
- [ ] Implementar a alteração necessária em `br.edu.ifpb.alumigest.onboarding`
