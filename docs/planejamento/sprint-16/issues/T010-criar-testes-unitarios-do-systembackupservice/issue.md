# [T010] Criar testes unitários do `SystemBackupServiceTest`
...
- **Labels Sugeridas**: `sprint-16`, `governance`, `security`, `audit`, `backup`, `backend`, `java`, `testing`, `mvp`, `user-story-1`, `backup`
