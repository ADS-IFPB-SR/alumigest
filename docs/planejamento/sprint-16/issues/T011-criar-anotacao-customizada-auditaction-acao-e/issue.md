# [T011] Criar anotação customizada `@AuditAction(acao, entidade)` em `backend/src/main/java/br/edu/ifpb/alumigest/admin/annotation/AuditAction.java`
...
- **Arquivo / Alvo Principal**: `backend/src/main/java/br/edu/ifpb/alumigest/admin/annotation/AuditAction.java`
- **Labels Sugeridas**: `sprint-16`, `governance`, `security`, `audit`, `backup`, `backend`, `java`, `mvp`, `user-story-2`, `audit`

---

## 🎯 Objetivo & Descrição

Criar anotação customizada `@AuditAction(acao, entidade)` em `backend/src/main/java/br/edu/ifpb/alumigest/admin/annotation/AuditAction.java`.
...
- [ ] Implementar a alteração necessária em `backend/src/main/java/br/edu/ifpb/alumigest/admin/annotation/AuditAction.java`
