# [T014] Criar endpoint GET /api/admin/audit-logs no `AuditLogController`
...
- **Arquivo / Alvo Principal**: `AuditLogController`
...
Criar endpoint GET /api/admin/audit-logs no `AuditLogController`.
...
- [ ] Implementar a alteração necessária em `AuditLogController`
