...
- **Labels Sugeridas**: `governance`, `security`, `audit`, `backup`, `backend`, `java`, `testing`, `mvp`, `user-story-1`, `backup`

---

## 🎯 Objetivo & Descrição

Criar testes unitários do `SystemBackupServiceTest`.
