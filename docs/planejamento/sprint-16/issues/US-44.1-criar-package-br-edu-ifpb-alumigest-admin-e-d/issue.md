...
- **Arquivo / Alvo Principal**: `br.edu.ifpb.alumigest.admin`
- **Labels Sugeridas**: `governance`, `security`, `audit`, `backup`, `frontend`, `typescript`, `react`

---

## 🎯 Objetivo & Descrição

Criar package `br.edu.ifpb.alumigest.admin` e diretório `frontend/src/features/admin`.
...
- [ ] Implementar a alteração necessária em `br.edu.ifpb.alumigest.admin`
