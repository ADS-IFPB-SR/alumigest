...
- **Arquivo / Alvo Principal**: `backend/src/main/java/br/edu/ifpb/alumigest/admin/domain/`
- **Labels Sugeridas**: `governance`, `security`, `audit`, `backup`, `backend`, `java`

---

## 🎯 Objetivo & Descrição

Criar entidades JPA `AuditLog` e `SystemBackup` em `backend/src/main/java/br/edu/ifpb/alumigest/admin/domain/`.
...
- [ ] Implementar a alteração necessária em `backend/src/main/java/br/edu/ifpb/alumigest/admin/domain/`
