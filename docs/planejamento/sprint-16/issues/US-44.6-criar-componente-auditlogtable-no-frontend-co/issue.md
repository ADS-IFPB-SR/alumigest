...
- **Labels Sugeridas**: `governance`, `security`, `audit`, `backup`, `frontend`, `typescript`, `react`, `mvp`, `user-story-2`, `audit`

---

## 🎯 Objetivo & Descrição

Criar componente `AuditLogTable` no frontend com filtros por entidade e data.
