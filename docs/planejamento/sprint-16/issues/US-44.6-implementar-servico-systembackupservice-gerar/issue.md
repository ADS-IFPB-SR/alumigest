...
- **ID da Tarefa**: `US-44.6`
- **US Pai**: `US-44: Executar Rotinas de Backup Automático e Disaster Recovery em 1 Comando`
...
- **Arquivo / Alvo Principal**: `backend/src/main/java/br/edu/ifpb/alumigest/admin/service/SystemBackupService.java`
- **Labels Sugeridas**: `governance`, `security`, `audit`, `backup`, `backend`, `java`, `mvp`, `user-story-1`, `backup`

---

## 🎯 Objetivo & Descrição

Implementar serviço `SystemBackupService.gerarBackup()` com `ProcessBuilder` e retenção de 30 dias em `backend/src/main/java/br/edu/ifpb/alumigest/admin/service/SystemBackupService.java`.
...
- [ ] Implementar a alteração necessária em `backend/src/main/java/br/edu/ifpb/alumigest/admin/service/SystemBackupService.java`
