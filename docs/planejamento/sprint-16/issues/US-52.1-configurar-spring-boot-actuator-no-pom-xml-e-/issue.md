...
- **Arquivo / Alvo Principal**: `pom.xml`
- **Labels Sugeridas**: `sprint-16`, `governance`, `security`, `audit`, `backup`, `backend`, `java`, `user-story-3`, `observability`

---

## 🎯 Objetivo & Descrição

Configurar Spring Boot Actuator no `pom.xml` e `application.yml`.
...
- [ ] Implementar a alteração necessária em `pom.xml`
