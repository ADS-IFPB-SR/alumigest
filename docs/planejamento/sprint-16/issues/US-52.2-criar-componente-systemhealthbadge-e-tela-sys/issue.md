...
- **Labels Sugeridas**: `sprint-16`, `governance`, `security`, `audit`, `backup`, `frontend`, `typescript`, `react`, `user-story-3`, `observability`

---

## 🎯 Objetivo & Descrição

Criar componente `SystemHealthBadge` e tela `SystemSettingsPage` no frontend.
