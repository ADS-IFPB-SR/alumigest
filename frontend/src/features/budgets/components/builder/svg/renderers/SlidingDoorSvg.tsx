...
export function renderSlidingDoor3F(
  ...
  return (
    <>
      ...
      <HandleElement handleConfig={handleConfig} svgH={svgH} frameW={fw} posX={handlePosX} mirrored={handleMirr} heightMm={heightMm} widthMm={_widthMm} leafW={thirdW} leafX={mobile2X} />
      <HandlePieceDimension svgH={svgH} frameW={fw} posX={handlePosX} handleConfig={handleConfig} heightMm={heightMm} widthMm={_widthMm} leafW={thirdW} leafX={mobile2X} mirrored={handleMirr} />
      {drillingConfig.holeCount > 0 && (
        <DrillingHoles
          svgH={svgH}
          svgW={svgW}
